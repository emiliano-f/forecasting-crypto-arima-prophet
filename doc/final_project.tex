...
Los gráficos (figura \ref{f:btc_wk_arima}) corresponden a el precio en un periodo de 7 días del Bitcoin (tomados 10 veces aleatoriamente), más otros siete días donde se compara la predicción del modelo y los valores reales. Adjuntamos las métricas para cada uno de ellos en el cuadro (\ref{tab:btc})

En tanto, la figura \ref{f:btc_mth_arima} recoge la misma información que los gráficos previamente presentados a excepción del modelo, que entrena con periodos de 30 días seleccionados aleatoriamente.
...
\begin{figure}[h!]
 \centering
  \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/1}}
  \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/2}} \\
  \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/3}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/4}} \\
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/5}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/6}} \\
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/7}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/8}} \\
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/9}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/week/10}}
  \caption{Predicción del modelo entrenado con 10 semanas aleatorias de BTC}
...
\begin{figure}[h!]
 \centering
  \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/1}}
  \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/2}} \\
  \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/3}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/4}} \\
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/5}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/6}} \\
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/7}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/8}} \\
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/9}}
   \subfloat[]{
   \includegraphics[width=0.5\textwidth]{./plots/prophet/btc/month/10}}
  \caption{Predicción del modelo entrenado con 10 meses aleatorios de BTC}
